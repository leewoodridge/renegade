    ...
    CASE Cmd OF
      '1' : BEGIN
              ...
              BEGIN
                ...
                Reset(UserFile);
                UNum := 1;
                WHILE (UNum <= (MaxUsers - 1)) AND (NOT AbortRG) AND (NOT HangUp) DO
                BEGIN
                  LoadURec(User,UNum);
      ...
      '2' : BEGIN
              ...
              Reset(UserFile);
              UNum := 1;
              WHILE (UNum <= (MaxUsers - 1)) AND (NOT AbortRG) AND (NOT HangUp) DO  (* Was X - 1 *)
              BEGIN
                LoadURec(User,UNum);
      ...
      '3' : BEGIN
              ...
              BEGIN
                ...
                Reset(UserFile);
                UNum := 1;
                WHILE (UNum <= NumMassMailList) AND (NOT AbortRG) AND (NOT HangUp) DO
                BEGIN
...
VAR
  ...
  BEGIN
    ...
    *)
    lRGLngStr(60,FALSE);
    NumDone := 1;
    WHILE (NumDone < (PageLength - 5)) AND (SNum1 >= 1) AND (SNum1 <= MNum) AND (NOT AbortRG) AND (NOT HangUp) DO
    BEGIN
